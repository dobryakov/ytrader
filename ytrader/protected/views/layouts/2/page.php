...
<head>
	...
	<meta name="description" content="<?= $this->CURRENT_SITE->name ?> | <?php echo CHtml::encode($this->model->gallery->sponsorgallery->name); ?> | <?= CHtml::encode($this->pageTitle); ?>"/>

	<link rel="canonical" href="<?=$this->canonicalUrl?>"/>

    <script type="text/javascript" src="<?=Controller::getStaticBase()?>/flvs/swfobject.js"></script>
